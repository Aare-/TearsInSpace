...
#	get_tree().get_root().get_node("root/Spaceship/electronics_left"  ).connect("body_enter",self,"particle_collided_with_wall")
#	get_tree().get_root().get_node("root/Spaceship/electronics_right" ).connect("body_enter",self,"particle_collided_with_wall")
#	get_tree().get_root().get_node("root/Spaceship/electronics_bottom").connect("body_enter",self,"particle_collided_with_wall")
